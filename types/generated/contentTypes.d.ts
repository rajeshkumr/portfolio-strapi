...
export interface ApiContactContact extends Schema.SingleType {
  ...
  attributes: {
    ...
    email: Attribute.Email;
    contact_forms: Attribute.Relation<
      'api::contact.contact',
      'oneToMany',
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    avatarIntro: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    subIntro: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contentGrid: Attribute.Media<
    ...
    bottomSection: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    projectGrid: Attribute.Component<'grid.projects'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectProject extends Schema.SingleType {
  ...
  attributes: {
    slideshow: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
